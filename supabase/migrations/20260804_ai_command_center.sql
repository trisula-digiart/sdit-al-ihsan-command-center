-- STREAMING_CHUNK:Creating tables for AI command center audit and templates...
-- SDIT Al Ihsan AI Command Center - Supabase PostgreSQL Migration
-- Target Path: supabase/migrations/20260804_ai_command_center.sql

-- 1. Tabel Audit Trail dan Tracking Penggunaan Token AI
...
-- STREAMING_CHUNK:Creating document templates table...
...
-- STREAMING_CHUNK:Enabling row level security policies...
...
-- STREAMING_CHUNK:Creating database indexes and seeding initial templates...
